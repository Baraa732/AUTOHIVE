...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'how_was_experience': 'How was your overall experience?',
      'rate_specific_aspects': 'Rate Specific Aspects',
      'cleanliness': 'Cleanliness',
      'value': 'Value',
      'communication': 'Communication',
      'share_your_experience': 'Share Your Experience',
      'tell_us_about_stay': 'Tell us about your stay...',
      'comment_max_length': 'Comment must be less than 1000 characters',
    ...
    'ar': {
      ...
      'sort_by': 'ترتيب حسب',
      'rate_stay': 'قيّم الإقامة',
      'overall_rating': 'التقييم الإجمالي',
      'how_was_experience': 'كيف كانت تجربتك الإجمالية؟',
      'rate_specific_aspects': 'قيّم جوانب محددة',
      'cleanliness': 'النظافة',
      'location': 'الموقع',
      'value': 'القيمة',
      'communication': 'التواصل',
      'share_your_experience': 'شارك تجربتك',
      'tell_us_about_stay': 'أخبرنا عن إقامتك...',
      'comment_max_length': 'يجب أن يكون التعليق أقل من 1000 حرف',
